        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-lg">Exam Notice Board</span>
            </div>
            <p className="text-white/50 text-sm leading-relaxed max-w-xs">
              All India government job notifications, updated automatically from official sources. Never miss a deadline.
            </p>
          </div>

          {/* Sources */}
          <div>
            <h4 className="font-semibold text-sm mb-3 text-white/80">Official Sources</h4>
          ...
          {/* Disclaimer */}
          <div>
            <h4 className="font-semibold text-sm mb-3 text-white/80">Disclaimer</h4>
