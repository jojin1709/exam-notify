        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 w-64 sm:w-72 bg-white rounded-xl border border-navy-200 shadow-lg p-3 sm:p-4 z-50">
            <div className="space-y-2.5 sm:space-y-3">
              <div>
                <label className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-navy-400 mb-1 block">Education</label>
                <select
                  value={filters.education}
                  onChange={(e) => update("education", e.target.value)}
                  className="w-full px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm bg-navy-50 border border-navy-200 rounded-lg focus:outline-none focus:border-navy-400"
                >
              ...
              <div>
                <label className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-navy-400 mb-1 block">Age Limit</label>
                <select
                  value={filters.age}
              ...
              <div>
                <label className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-navy-400 mb-1 block">Category</label>
                <select
                  value={filters.caste}
              ...
              {hasFilters && (
                <button
                  onClick={() => setFilters({ education: "all", age: "all", caste: "all" })}
                  className="w-full text-[11px] sm:text-xs font-medium text-danger-600 hover:text-danger-700 py-1"
                >
                  Clear Filters
                </button>
              )}
